...
namespace Bot.Persistence.Migrations
{
    ...
    [Migration("20250213074905_changed_reminder_model")]
    partial class changed_reminder_model
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bot.Contracts.Entities.Reminder", b =>
                {
                    ...
                    b.Property<string>("PreReminderJobId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("pre_reminder_job_id");
